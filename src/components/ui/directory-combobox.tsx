...
export function DirectoryCombobox({
  ...
  const filteredDirectories = React.useMemo(() => {
    ...
    return visibleDirectories.filter((dir) => dir.name.toLowerCase().includes(search.toLowerCase()))
  }, [directories, search])
      ...
      <PopoverTrigger asChild>
        ...
        >
          <div className="flex items-center gap-2 truncate">
            ...
            <span className="truncate">{selectedDir ? selectedDir.name : placeholder}</span>
          </div>
